return {
    ...
    opts = {
		...
		enabled = false
            -- win = {
            --     keys = {
            --         nav_h = { "<C-h>", "<C-\\><C-n>h" desc = "Go to Left Window", expr = true, mode = "t" },
            --         nav_j = { "<C-j>", "<C-\\><C-n>j" desc = "Go to Lower Window", expr = true, mode = "t" },
            --         nav_k = { "<C-k>", "<C-\\><C-n>k", desc = "Go to Upper Window", expr = true, mode = "t" },
            --         nav_l = { "<C-l>", "<C-\\><C-n>l", desc = "Go to Right Window", expr = true, mode = "t" },
            --     },
            -- },
        },
        dashboard = {
...
█  ███   ███      ███  ████████        ███      ███  ████  █
    ...
    keys = {
		...
		-- { "<c-q>",      function() Snacks.terminal() end, desc = "Toggle Terminal" },
